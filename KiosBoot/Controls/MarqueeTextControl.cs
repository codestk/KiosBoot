...
namespace MarqueeText
{
    ...
    public sealed class MarqueeTextControl : Control
    {
        ...
        public MarqueeTextControl()
            : base()
        {
            this.DefaultStyleKey = typeof(MarqueeTextControl);
        ...
        #region Properties
        private static readonly DependencyProperty TextProperty = DependencyProperty.Register(nameof(Text), typeof(string), typeof(MarqueeTextControl), new PropertyMetadata(null,
            (sender, e) =>
            {
        ...
        private static readonly DependencyProperty EasingFunctionProperty = DependencyProperty.Register(nameof(EasingFunction), typeof(EasingFunctionBase), typeof(MarqueeTextControl), new PropertyMetadata(null,
            (sender, e) =>
            {
                var control = (MarqueeTextControl)sender;
        ...
        private static readonly DependencyProperty AnimationDurationProperty = DependencyProperty.Register(nameof(AnimationDuration), typeof(TimeSpan), typeof(MarqueeTextControl), new PropertyMetadata(TimeSpan.FromSeconds(4),
            (sender, e) =>
            {
                var control = (MarqueeTextControl)sender;
        ...
        private static readonly DependencyProperty IsTickerProperty = DependencyProperty.Register(nameof(IsTicker), typeof(bool), typeof(MarqueeTextControl), new PropertyMetadata(false,
            (sender, e) =>
            {
                var control = (MarqueeTextControl)sender;
